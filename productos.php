...
<td  width="15%">   <a href="agregar_producto.php" class="btn btn-primary"> Agregar Producto <span class="glyphicon glyphicon-glass
"></span></a></td> 

<td  width="15%">   <a href="agregar_proveedor.php" class="btn btn-danger"> Agregar Proveedor <span class="glyphicon glyphicon-share-alt
"></span></a></td> 
<td  width="15%">   <a href="agregar_categoria.php" class="btn btn-warning"> Agregar Categoría <span class="glyphicon glyphicon-th
"></span></a></td> 
...
<th><center>Categoría</center></th>
 ...
 <th><center>Mínimo de venta</center></th>
...
<td>    <center> <?php echo $rs->codigo; ?> </center>   </td>

<td>    <?php echo $rs->deshort; ?>   </td>

<td>    <center><?php echo $rs->precio_venta."$";  ?> </center>  </td>
<td>    <center><?php echo $rs->categoria;  ?> </center>  </td>

<td>    <center>agregar BD </center>  </td>
<td>   <center> <?php echo $rs->stockbodega; ?> </center>  </td>
<td> <center><?php 
