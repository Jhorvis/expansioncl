      ...
      <div id="top-panel" class="col-xs-12 col-sm-10">
        <div class="row">
          ...
          <div class="col-xs-4 col-sm-8 top-panel-right">
            ...
            <a href="home.php" class="style2"></a>
    ...
    <div id="sidebar-left" class="col-xs-2 col-sm-2">
      <ul class="nav main-menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="ajax-link" href="ajax/agregar_producto.php">Agregar Producto</a></li>
            <li><a class="ajax-link" href="ajax/agregar_categoria.php">Agregar Categoría</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="ajax-link" href="ajax/forms_file_uploader.html">Agregar Proveedor</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="ajax/page_login_v2.html">Login</a></li>
            <li><a href="ajax/page_register_v2.html">Register</a></li>
            ...
            <li><a href="ajax/page_500_v2.html">Error 500</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle">
        ...
        <li class="dropdown">
          ...
          <a href="#" class="dropdown-toggle">
            <i class="fa fa-user"></i>
             <span class="hidden-xs">Área de adminsitrador</span>
          </a>
          <ul class="dropdown-menu">
            <li><a class="ajax-link" href="ajax/gallery_simple.html">Cuentas de usuario</a></li>
            <li><a class="ajax-link" href="#">Otros</a></li>
          </ul>
        </li>
        <li>
