...
$RUT =  $_GET ['rt'];
$datos=$a->Verificarproveedor(@$RUT);
foreach ($datos as $rr) {}
$idproveedor = $rr->idproveedor;
$datos2=$a->verificarproductosencompra(@$idproveedor);
      ...
      <div class="box-content">
        <form id="defaultForm" method="post" action="ajax/validar_categorias.php" class="form-horizontal" enctype="multipart/form-data">
          ...
          <input type="hidden" name="idproveedor" value="<?php echo $rr->idproveedor ?>">
             <input type="hidden" name="rut" value="<?php echo $rr->RUT_empresa ?>">

              <div class="col-sm-4">
                <input type="number" class="form-control" name="cantidad" placeholder="Cantidad de productos" />
              </div>
                <div class="col-sm-4">
                <input type="text" class="form-control" name="precio" placeholder="Precio de compra por unidad"
...
echo "<center><a href='ajax/quitar_de_factura.php?id=$rt->idorden&value=$RUT';\"><img src='img/deleted.png' width='32' height='27'</a></center>";
...
Nombre: <b><?php echo $rr->nombrempresa; ?> </b>
<br>
   
RUT: <b><?php echo $rr->RUT_empresa; ?></b> 
 <br>
  Teléfono: <b><?php echo $rr->tlf1; ?> </b>
...
<form method="POST" ction="ajax/validar_categorias.php">
...
<br>Total: <b><?php $suma=$a->totalcompra(@$idproveedor); 
foreach ($suma as $sm);
 $total = $sm->total; 
echo $total; ?>$</b>
<br>
<br>
<a  id='btnt'   data-toggle='modal' data-target='#myModal14' class="btn btn-success" role='button' name='continuar'> Continuar </a><br><br>
